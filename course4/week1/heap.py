...
'''
    my implementation of a min and max heap copied from a previous week for use in applying
    dijkstra's algorithm to solve the all-pairs shortest path problem.
'''
